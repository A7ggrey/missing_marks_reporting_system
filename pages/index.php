  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <?php
          ...
          $query = "SELECT * FROM marks WHERE marksstatus = '0' AND stmrkid = '$session'";
          $query1 = "SELECT * FROM marks WHERE marksstatus = '1' AND stmrkid = '$session'";
          $query2 = "SELECT * FROM marks WHERE marksstatus = '2' AND stmrkid = '$session'";
          $query3 = "SELECT * FROM marks WHERE marksstatus = '3' AND stmrkid = '$session'";
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              <div class="inner">
                ...
                <p>Not Uploaded Marks</p>
              </div>
              <div class="icon">
                <i class="ion ion-android-arrow-down"></i>
              </div>
              <a href="./progress.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-warning">
              <div class="inner">
                ...
                <p>Marks Reviewed Successfully</p>
              </div>
              <div class="icon">
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-danger">
              <div class="inner">
                ...
                <p>Pending. Visit Examiner office</p>
              </div>
              <div class="icon">
