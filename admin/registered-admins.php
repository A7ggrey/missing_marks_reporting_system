...
<head>
  ...
  <title>MSU | Registered Admins</title>
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Status all Registered Admins</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <?php
                      ...
                      while ($rowsdisplay = mysqli_fetch_assoc($result)) {
                        ...
                        <tr>
                    <td><?php echo $rowsdisplay['lname'];?></td>
                    <td><?php echo $rowsdisplay['fname'];?></td>
                    <td><?php echo $rowsdisplay['oname'];?></td>
