              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <?php
                      ...
                      $query = "SELECT marks.*, lecturer.*, units.*, yrofstudy.* FROM marks INNER JOIN lecturer ON marks.lecid = lecturer.lecid INNER JOIN units ON marks.unitname = units.unitid INNER JOIN yrofstudy ON marks.yearofexam = yrofstudy.yrid WHERE marks.marksstatus = '0'";
