              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <?php
                      ...
                      $query = "SELECT marks.*, student.*, units.*, yrofstudy.* FROM marks INNER JOIN student ON marks.stmrkid = student.stid INNER JOIN units ON marks.unitname = units.unitid INNER JOIN yrofstudy ON marks.yearofexam = yrofstudy.yrid WHERE marks.marksstatus = '3'";
