        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Updated Marks</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Marks Uploaded by Lecturer</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <div>
                  ...
                  if (isset($_POST['approve-button'])) {
                    $query2 = "UPDATE marks SET marksstatus = '2' WHERE marksstatus = '1'";
                      ...
                      if ($result2) {
                        ...
                        echo "<script>
                                alert('Updated Marks Approved Successfully');
                                location.replace('updated-marks.php');
                              </script>";
                      } else {
                  ...
                  <form action="" method="POST">
                    <input type="submit" name="approve-button" value="Approve all Uploaded Marks" class="btn btn-success">
                  </form>
                </div><br>
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <?php
                      ...
                      $query = "SELECT marks.*, lecturer.*, student.*, units.*, yrofstudy.* FROM marks INNER JOIN lecturer ON marks.lecid = lecturer.lecid INNER JOIN units ON marks.unitname = units.unitid INNER JOIN yrofstudy ON marks.yearofexam = yrofstudy.yrid INNER JOIN student ON marks.stmrkid = student.stid WHERE marks.marksstatus = '1'";
