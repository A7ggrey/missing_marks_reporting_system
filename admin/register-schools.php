<?php
   ...
   if (isset($_POST['submit'])) {
      ...
      $sc = mysqli_real_escape_string($conn, $schoolcode);
      $sn = mysqli_real_escape_string($conn, $schoolname);
      
      $query = "SELECT * FROM schools WHERE schcode = '$sc'";
      ...
      if (mysqli_num_rows($result) > 0) {
        ...
        $query1 = "INSERT INTO schools(schname, schcode) VALUES('$sn', '$sc')";
        $result1 = mysqli_query($conn, $query1);

        if ($result1) {
          
          $msg = "School's details Inserted successfully";
        } else {
...
<head>
  ...
  <title>MSU | Register Schools</title>
              ...
              <form method="POST" action="">
                <div class="card-body">
                  <div class="col-sm-12">
                      ...
                      <div>
                        <button type="submit" name="submit" class="btn btn-primary">Register Schools</button>
                      </div>
