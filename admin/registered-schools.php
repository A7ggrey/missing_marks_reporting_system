...
<head>
  ...
  <title>MSU | Registered Schools</title>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">All Registered Schools</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Status all Registered Schools</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <?php
                      ...
                      $query = "SELECT schools.*, examcoordinators.* FROM examcoordinators INNER JOIN schools ON schools.schlid = examcoordinators.school";
                      ...
                      while ($rowsdisplay = mysqli_fetch_assoc($result)) {
                        ...
                        <tr>
                    <td><?php echo $rowsdisplay['schcode'];?></td>
                    <td><?php echo $rowsdisplay['schname'];?></td>
                    <td><?php echo $rowsdisplay['email'];?></td>
                    <td><?php echo $rowsdisplay['pnumber'];?></td>
                    <td><?php echo $rowsdisplay['pnumber'];?></td>
                  </tr>
