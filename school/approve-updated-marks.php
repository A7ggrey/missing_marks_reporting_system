<?php
   ...
   if (isset($_POST['btn-confirm'])) {
       ...
       if ($result1) {
           ...
           echo "<script>alert('Marks Updated Successfully'); location.replace('./approve-updated-marks.php');</script>";
       } else {
...
<head>
  ...
  <title>MSU | Update and Approve Marks</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Marks Updates and Approval</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="./">Home</a></li>
              <li class="breadcrumb-item active">Update and Approve Marks</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Update and Approve pending marks</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <?php
                      ...
                      $query = "SELECT marks.*, student.*, units.*, yrofstudy.* FROM marks INNER JOIN student ON marks.stmrkid = student.stid INNER JOIN units ON marks.unitname = units.unitid INNER JOIN yrofstudy ON marks.yearofexam = yrofstudy.yrid WHERE marks.stdschid = '$sch123' AND marks.marksstatus = '3'";
                  ...
                  <form action="" method="POST">
                    ...
                    <td>
                      <input type="submit" name="btn-confirm" value="Update Pending Marks" class="btn btn-primary">
                    </td>
