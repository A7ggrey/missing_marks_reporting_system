              ...
              <div class="card-body">
                <div>
                  ...
                  if (isset($_POST['approve-button'])) {
                    $query2 = "UPDATE marks SET marksstatus = '2' WHERE marksstatus = '1' AND stdschid = '$sch123'";
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <?php
                      ...
                      $query = "SELECT marks.*, lecturer.*, student.*, units.*, yrofstudy.* FROM marks INNER JOIN lecturer ON marks.lecid = lecturer.lecid INNER JOIN units ON marks.unitname = units.unitid INNER JOIN yrofstudy ON marks.yearofexam = yrofstudy.yrid INNER JOIN student ON marks.stmrkid = student.stid WHERE marks.stdschid = '$sch123' AND marks.marksstatus = '1'";
