...
<head>
  ...
  <title>MMUST | Lecturer Dashboard</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <?php
          ...
          $query = "SELECT * FROM marks WHERE marksstatus = '0' AND lecid = '$currentL'";
          $query1 = "SELECT * FROM marks WHERE marksstatus = '1' AND lecid = '$currentL'";
          $query2 = "SELECT * FROM marks WHERE marksstatus = '2' AND lecid = '$currentL'";
          $query3 = "SELECT * FROM marks WHERE marksstatus = '3' AND lecid = '$currentL'";
        ...
        <div class="row">
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              ...
              <a href="./marks.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
